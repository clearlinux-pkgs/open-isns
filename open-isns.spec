...
Source0  : https://github.com/open-iscsi/open-isns/archive/v0.101/open-isns-0.101.tar.gz
...
%prep
%setup -q -n open-isns-0.101
cd %{_builddir}/open-isns-0.101
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612291510
...
cp %{_builddir}/open-isns-0.101/COPYING %{buildroot}/usr/share/package-licenses/open-isns/9a647436aa2324c4cb849c6f3d31c392ed50d9bd
...
/usr/share/man/man8/isnssetup.8
