...
%prep
%setup -q -n open-isns-0.102
cd %{_builddir}/open-isns-0.102
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662691940
...
cp %{_builddir}/open-isns-%{version}/COPYING %{buildroot}/usr/share/package-licenses/open-isns/9a647436aa2324c4cb849c6f3d31c392ed50d9bd
...
/usr/lib64/pkgconfig/libisns.pc
